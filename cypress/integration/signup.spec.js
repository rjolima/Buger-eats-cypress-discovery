...
describe('Signup', () => {
    ...
    it('User should be deliver', function () {
        ...
        signupPage.deliverMethod(deliver)
        signupPage.submit()
    ...
    it('Incorrect e-amil', function () {
        ...
        signupPage.deliverMethod(deliver)
        signupPage.submit()
        signupPage.alertMessageShoulBe('Oops! Email com formato inválido.')

    })

    it('Incorrect delivery method', function () {
        ...
        signupPage.fillForm(deliver)
        signupPage.submit()
        signupPage.alertMessageShoulBeDeliver('Selecione o método de entrega')
